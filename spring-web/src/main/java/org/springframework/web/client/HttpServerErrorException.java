		...
		if (statusCode instanceof HttpStatus status) {
			switch (status) {
				case INTERNAL_SERVER_ERROR:
					return message != null ?
							new HttpServerErrorException.InternalServerError(message, statusText, headers, body,
									charset) :
				...
				case SERVICE_UNAVAILABLE:
					return message != null ?
							new HttpServerErrorException.ServiceUnavailable(message, statusText, headers, body,
									charset) :
