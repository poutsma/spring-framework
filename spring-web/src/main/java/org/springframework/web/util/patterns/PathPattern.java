...
public class PathPattern implements Comparable<PathPattern> {
	 ...
	 * @return the remaining path after as much has been consumed as possible by this pattern, can be
	 * the empty string or it will be null if path does not match
	 */
