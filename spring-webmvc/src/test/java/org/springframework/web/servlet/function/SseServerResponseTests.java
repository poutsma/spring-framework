...
class SseServerResponseTests {
	...
	void sendString() throws Exception {
		String body = "foo bar";
		ServerResponse response = ServerResponse.sse(sse -> sse.send(body));
	...
	void sendObject() throws Exception {
		...
		ServerResponse response = ServerResponse.sse(sse -> sse.send(person));
	...
	public void builder() throws Exception {
		String body = "foo bar";
		ServerResponse response = ServerResponse.sse(sse -> sse
				.id("id")
				.event("name")
