...
public interface Transport {
	 ...
	 * @deprecated as of 6.0, in favor of {@link #connectTo(TransportRequest, WebSocketHandler)}
	 */
	@Deprecated
	default ListenableFuture<WebSocketSession> connect(TransportRequest request, WebSocketHandler webSocketHandler) {
		return new CompletableToListenableFutureAdapter<>(connectTo(request, webSocketHandler));
	}

	CompletableFuture<WebSocketSession> connectTo(TransportRequest request, WebSocketHandler webSocketHandler);
